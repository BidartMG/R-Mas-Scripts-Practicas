...
peliculas_df[c(3,4),c('PUNTUACIÓN','POSTERIOR_2005')]
...
order_menor_mayor <- order(decreasing = FALSE, peliculas_df$PUNTUACIÓN)

# mostrar el dataframe ordenado
peliculas_df[order_menor_mayor,]

# funcion order (mayor a menor)
order_mayor_menor <- order(decreasing = TRUE, peliculas_df$PUNTUACIÓN)
